...
\begin{proof}
	Sem perda de generalidade suponha que $L = \mathcal{L}(A)$ para algum AFD $A = \langle \{q_1, \cdots, q_n\}, X, \delta, q_1, F$ em que $n \geq 1$. Agora será construído para todo $k \leq n$ a expressão regular $r^k_{i,j}$ é definida recursivamente como sendo:
	\begin{eqnarray*}
		r^0_{i,j} & = &  \left\{
		\begin{array}{ll}	
